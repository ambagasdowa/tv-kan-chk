...
from tvKanChk import VERSION, VERSION_SHORT  # noqa: E402

# -- Project information -----------------------------------------------------

project = "tvKanChk"
copyright = f"{datetime.today().year}, Jesus Baizabal"
...
html_title = f"tvKanChk v{VERSION}"
...
html_theme_options = {
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/ambagasdowa/tv-kan-chk",
            "html": """
